...
export default function ReceivePage()
 ...
 useEffect(() => {
  ...
  <h1 className="mt-6 font-serif text-4xl">This Rakhi is waiting to travel.</h1>
  <p className="mt-4 text-sm leading-6 text-[#756C78]">This frontend preview stores Rakhi details only in the creator’s browser. Shared links will work across devices once the database is connected.</p>
<RakhiButton onClick={submit} className="mt-7">
  START THE JOURNEY
</RakhiButton>
