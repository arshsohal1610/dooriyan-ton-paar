...
export default function SendPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#FFFDF8] text-[#40364A]">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-md flex-col justify-center px-5 text-center">
        ...
        <p className="mt-5 text-sm leading-7 text-[#756C78]">
          Send this private link to your brother when the moment feels right.
        </p>

        <article className="glass mt-9 rounded-[28px] p-6 text-left shadow-[0_20px_60px_rgba(80,60,100,.08)]">

          <p className="text-center font-serif text-xl">
            Distance means so little when someone means so much.
          </p>

          <div className="my-6 h-px bg-[#D9B77A]/20" />

          <p className="mb-2 text-xs font-medium text-[#5C4B73]">
            Your special Rakhi link
          </p>
